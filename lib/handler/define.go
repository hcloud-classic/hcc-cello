...
var iscsioption = "netroot=iscsi:CELLO_PXE_CONF_ISCSI_SERVER_IP:tcp:3260:0:CELLO_PXE_CONF_ISCSI_TARGET_DOMAIN iscsi_initiator=iqn.CELLO_PXE_CONF_ISCSI_TARGET_DOMAIN.hcc withiscsi=1"
